    ...
    <section id="contact" className="mt-10 pt-20">
      <div className="md:px-24 xl:px-0">
        ...
        <p className="mt-8 text-gray-400 text-base md:text-lg">
          My Inbox is always open for new ideas and exciting discussions. If you
          have some exciting project in mind, or just want to chat, get in touch
          with me here...
        </p>
        ...
        <p className="flex items-center text-gray-400 text-lg gap-4 mt-4">
          <span className="flex gap-2 text-sm md:text-lg items-center text-gray font-bold  text-blue-500">
            <FaWhatsapp /> Phone:
          </span>
          +916294716288
        </p>
